      ...
      <Container>
        <Row>
          <Col xs={12} sm={6} md={4} lg={3} className="pb-4 pb-lg-0">
            ...
            <p>
              <a href="mailto:help@ebullion.in">help@ebullion.in</a>
            </p>
          </Col>
          ...
          <Col
            ...
            md={4}
            lg={3}
            className="justify-content-between d-flex flex-column align-items-center text-center"
          >
            ...
            <ul className="list-unstyled d-flex social-media-icons pb-3 pb-md-0">
              ...
              <li>
                <a href="#">
                  <Image src={youtube} className="img-fluid" />
                </a>
              </li>
              <li>
                <a href="#">
